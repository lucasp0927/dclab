 ...
 *
 * Generated: 2010-07-20 19:15:00.949
 *
 */
...
MEMORY
{
    ...
    onchip_memory2_0 : ORIGIN = 0x00008020, LENGTH = 20448
}

    /* Define symbols for each memory base-address */
 __alt_mem_onchip_memory2_0 = 0x00008000 ;
...
SECTIONS
{
    ...
    .text :
    {
        ...
        *(.dynamic)
        ...
        KEEP (*(.jcr))
        . = ALIGN(32 / 8);
    } >  onchip_memory2_0 =0x3a880100 /* NOP on Nios2 (big endian) */
...
PROVIDE( __alt_heap_limit    = 0x0000d000 );
